...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_ergodonk(
                //┌────────┬────────┬────────┬────────┬────────┬────────┬────────┬────────┐  
		          ...
		          KC_GRV , KC_1    , KC_2      , KC_3   , KC_4        , KC_5   , HPT_TOG, KC_VOLU,        KC_PSCR, KC_INS , KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , KC_MINS, KC_EQL , KC_BSPC, 
		          KC_TAB , KC_Q      , KC_W      , KC_E   , KC_R        , KC_T   , HPT_DWLI, KC_VOLD,        KC_SLCK, KC_DEL , KC_Y   , KC_U   , KC_I   , KC_O   , KC_P   , KC_LBRC, KC_RBRC, KC_BSLS, 
		          LT(1,KC_CAPS), LT(2,KC_A), LCTL_T(KC_S), KC_D   , LGUI_T(KC_F), KC_G   , HPT_DWLD, KC_MUTE,        KC_NO  , KC_5   , KC_H  ,RGUI_T(KC_J),KC_K,RCTL_T(KC_L),LT(2,KC_SCLN),LT(1,KC_QUOT), KC_ENT, 
    ...
    [_CATSAFE] = LAYOUT_ergodonk(
        // This entire layer is disabled. Upperleft key to return to normal.
